...
export default function ReactivationStep({ onNext, onDisqualify }: Props) {
  ...
  return (
    <div className="glass-card rounded-xl p-6 sm:p-8 max-w-2xl mx-auto">
      <h2 className="text-xl font-bold text-foreground mb-4">Habilidad de reactivación</h2>
      ...
      <textarea
        ...
        placeholder="Escribe exactamente lo que le enviarías..."
        rows={5}
      ...
      />
      <p className="text-xs text-muted-foreground/60 mt-1 text-right">{msg.length} / 500 caracteres</p>
